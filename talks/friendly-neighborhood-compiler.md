...
So if you've heard me say something like "Typescript is a tool for writing better Javascript" and thought "yeah right, it's just a way to make me write more code" then _this_ is what I've been trying to tell you. Hopefully the illustration helps. It's not a tool for making you write more code, or making you jump through hoops to appease some fussy bureaucrat gatekeeping you out in the cold, it's a tool for making you write _better_ code. Not just in the large in a big project to keep somebody else from pulling the rug out from under you, but in the small in the code you're writing in any given moment. I don't think static language advocates do a good enough job explaining this.

So the typechecker can be a fantastically useful tool if you make this perspective shift. But it _is_ a perspective shift: there isn't One Weird Trick to being productive in Typescript, you have to change your conception of [what a program is](https://www.destroyallsoftware.com/talks/ideology). So please, take the time to learn how to use Typescript properly. It will make your life easier in the long run.
